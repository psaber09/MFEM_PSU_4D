...
{
   std::cout << "DoNodeReorder" << std::endl;
   FiniteElementSpace *fes = Nodes->FESpace();
      ...
      for (int i = 0; i < GetNE(); i++)
      {
         ...
         switch (geom)
         {
            ...
            case Geometry::TETRAHEDRON:
               ...
               std::cout << "Node Reorder Tet" << std::endl;
...
int Mesh::GetPentOrientation(const int *base, const int *test)
{
   // Static method.
   // This function computes the index 'j' of the permutation that transforms
   // test into base: test[tet_orientation[j][i]]=base[i].
   // tet_orientation = Geometry::Constants<Geometry::TETRAHEDRON>::Orient
    std::cout << "Pent Code used" << std::endl;
   int orient;

    if((base[0]==test[ 4 ])&&(base[1]==test[ 3 ])&&(base[2]==test[ 2 ])&&(base[3]==test[ 1 ])&&(base[4]==test[ 0 ]))
    {
     orient =  0 ;
     }

    if((base[0]==test[ 4 ])&&(base[1]==test[ 3 ])&&(base[2]==test[ 2 ])&&(base[3]==test[ 0 ])&&(base[4]==test[ 1 ]))
    {
     orient =  1 ;
     }

    if((base[0]==test[ 4 ])&&(base[1]==test[ 3 ])&&(base[2]==test[ 1 ])&&(base[3]==test[ 2 ])&&(base[4]==test[ 0 ]))
    {
     orient =  2 ;
     }

    if((base[0]==test[ 4 ])&&(base[1]==test[ 3 ])&&(base[2]==test[ 1 ])&&(base[3]==test[ 0 ])&&(base[4]==test[ 2 ]))
    {
     orient =  3 ;
     }

    if((base[0]==test[ 4 ])&&(base[1]==test[ 3 ])&&(base[2]==test[ 0 ])&&(base[3]==test[ 2 ])&&(base[4]==test[ 1 ]))
    {
     orient =  4 ;
     }

    if((base[0]==test[ 4 ])&&(base[1]==test[ 3 ])&&(base[2]==test[ 0 ])&&(base[3]==test[ 1 ])&&(base[4]==test[ 2 ]))
    {
     orient =  5 ;
     }

    if((base[0]==test[ 4 ])&&(base[1]==test[ 2 ])&&(base[2]==test[ 3 ])&&(base[3]==test[ 1 ])&&(base[4]==test[ 0 ]))
    {
     orient =  6 ;
     }

    if((base[0]==test[ 4 ])&&(base[1]==test[ 2 ])&&(base[2]==test[ 3 ])&&(base[3]==test[ 0 ])&&(base[4]==test[ 1 ]))
    {
     orient =  7 ;
     }

    if((base[0]==test[ 4 ])&&(base[1]==test[ 2 ])&&(base[2]==test[ 1 ])&&(base[3]==test[ 3 ])&&(base[4]==test[ 0 ]))
    {
     orient =  8 ;
     }

    if((base[0]==test[ 4 ])&&(base[1]==test[ 2 ])&&(base[2]==test[ 1 ])&&(base[3]==test[ 0 ])&&(base[4]==test[ 3 ]))
    {
     orient =  9 ;
     }

    if((base[0]==test[ 4 ])&&(base[1]==test[ 2 ])&&(base[2]==test[ 0 ])&&(base[3]==test[ 3 ])&&(base[4]==test[ 1 ]))
    {
     orient =  10 ;
     }

    if((base[0]==test[ 4 ])&&(base[1]==test[ 2 ])&&(base[2]==test[ 0 ])&&(base[3]==test[ 1 ])&&(base[4]==test[ 3 ]))
    {
     orient =  11 ;
     }

    if((base[0]==test[ 4 ])&&(base[1]==test[ 1 ])&&(base[2]==test[ 3 ])&&(base[3]==test[ 2 ])&&(base[4]==test[ 0 ]))
    {
     orient =  12 ;
     }

    if((base[0]==test[ 4 ])&&(base[1]==test[ 1 ])&&(base[2]==test[ 3 ])&&(base[3]==test[ 0 ])&&(base[4]==test[ 2 ]))
    {
     orient =  13 ;
     }

    if((base[0]==test[ 4 ])&&(base[1]==test[ 1 ])&&(base[2]==test[ 2 ])&&(base[3]==test[ 3 ])&&(base[4]==test[ 0 ]))
    {
     orient =  14 ;
     }

    if((base[0]==test[ 4 ])&&(base[1]==test[ 1 ])&&(base[2]==test[ 2 ])&&(base[3]==test[ 0 ])&&(base[4]==test[ 3 ]))
    {
     orient =  15 ;
     }

    if((base[0]==test[ 4 ])&&(base[1]==test[ 1 ])&&(base[2]==test[ 0 ])&&(base[3]==test[ 3 ])&&(base[4]==test[ 2 ]))
    {
     orient =  16 ;
     }

    if((base[0]==test[ 4 ])&&(base[1]==test[ 1 ])&&(base[2]==test[ 0 ])&&(base[3]==test[ 2 ])&&(base[4]==test[ 3 ]))
    {
     orient =  17 ;
     }

    if((base[0]==test[ 4 ])&&(base[1]==test[ 0 ])&&(base[2]==test[ 3 ])&&(base[3]==test[ 2 ])&&(base[4]==test[ 1 ]))
    {
     orient =  18 ;
     }

    if((base[0]==test[ 4 ])&&(base[1]==test[ 0 ])&&(base[2]==test[ 3 ])&&(base[3]==test[ 1 ])&&(base[4]==test[ 2 ]))
    {
     orient =  19 ;
     }

    if((base[0]==test[ 4 ])&&(base[1]==test[ 0 ])&&(base[2]==test[ 2 ])&&(base[3]==test[ 3 ])&&(base[4]==test[ 1 ]))
    {
     orient =  20 ;
     }

    if((base[0]==test[ 4 ])&&(base[1]==test[ 0 ])&&(base[2]==test[ 2 ])&&(base[3]==test[ 1 ])&&(base[4]==test[ 3 ]))
    {
     orient =  21 ;
     }

    if((base[0]==test[ 4 ])&&(base[1]==test[ 0 ])&&(base[2]==test[ 1 ])&&(base[3]==test[ 3 ])&&(base[4]==test[ 2 ]))
    {
     orient =  22 ;
     }

    if((base[0]==test[ 4 ])&&(base[1]==test[ 0 ])&&(base[2]==test[ 1 ])&&(base[3]==test[ 2 ])&&(base[4]==test[ 3 ]))
    {
     orient =  23 ;
     }

    if((base[0]==test[ 3 ])&&(base[1]==test[ 4 ])&&(base[2]==test[ 2 ])&&(base[3]==test[ 1 ])&&(base[4]==test[ 0 ]))
    {
     orient =  24 ;
     }

    if((base[0]==test[ 3 ])&&(base[1]==test[ 4 ])&&(base[2]==test[ 2 ])&&(base[3]==test[ 0 ])&&(base[4]==test[ 1 ]))
    {
     orient =  25 ;
     }

    if((base[0]==test[ 3 ])&&(base[1]==test[ 4 ])&&(base[2]==test[ 1 ])&&(base[3]==test[ 2 ])&&(base[4]==test[ 0 ]))
    {
     orient =  26 ;
     }

    if((base[0]==test[ 3 ])&&(base[1]==test[ 4 ])&&(base[2]==test[ 1 ])&&(base[3]==test[ 0 ])&&(base[4]==test[ 2 ]))
    {
     orient =  27 ;
     }

    if((base[0]==test[ 3 ])&&(base[1]==test[ 4 ])&&(base[2]==test[ 0 ])&&(base[3]==test[ 2 ])&&(base[4]==test[ 1 ]))
    {
     orient =  28 ;
     }

    if((base[0]==test[ 3 ])&&(base[1]==test[ 4 ])&&(base[2]==test[ 0 ])&&(base[3]==test[ 1 ])&&(base[4]==test[ 2 ]))
    {
     orient =  29 ;
     }

    if((base[0]==test[ 3 ])&&(base[1]==test[ 2 ])&&(base[2]==test[ 4 ])&&(base[3]==test[ 1 ])&&(base[4]==test[ 0 ]))
    {
     orient =  30 ;
     }

    if((base[0]==test[ 3 ])&&(base[1]==test[ 2 ])&&(base[2]==test[ 4 ])&&(base[3]==test[ 0 ])&&(base[4]==test[ 1 ]))
    {
     orient =  31 ;
     }

    if((base[0]==test[ 3 ])&&(base[1]==test[ 2 ])&&(base[2]==test[ 1 ])&&(base[3]==test[ 4 ])&&(base[4]==test[ 0 ]))
    {
     orient =  32 ;
     }

    if((base[0]==test[ 3 ])&&(base[1]==test[ 2 ])&&(base[2]==test[ 1 ])&&(base[3]==test[ 0 ])&&(base[4]==test[ 4 ]))
    {
     orient =  33 ;
     }

    if((base[0]==test[ 3 ])&&(base[1]==test[ 2 ])&&(base[2]==test[ 0 ])&&(base[3]==test[ 4 ])&&(base[4]==test[ 1 ]))
    {
     orient =  34 ;
     }

    if((base[0]==test[ 3 ])&&(base[1]==test[ 2 ])&&(base[2]==test[ 0 ])&&(base[3]==test[ 1 ])&&(base[4]==test[ 4 ]))
    {
     orient =  35 ;
     }

    if((base[0]==test[ 3 ])&&(base[1]==test[ 1 ])&&(base[2]==test[ 4 ])&&(base[3]==test[ 2 ])&&(base[4]==test[ 0 ]))
    {
     orient =  36 ;
     }

    if((base[0]==test[ 3 ])&&(base[1]==test[ 1 ])&&(base[2]==test[ 4 ])&&(base[3]==test[ 0 ])&&(base[4]==test[ 2 ]))
    {
     orient =  37 ;
     }

    if((base[0]==test[ 3 ])&&(base[1]==test[ 1 ])&&(base[2]==test[ 2 ])&&(base[3]==test[ 4 ])&&(base[4]==test[ 0 ]))
    {
     orient =  38 ;
     }

    if((base[0]==test[ 3 ])&&(base[1]==test[ 1 ])&&(base[2]==test[ 2 ])&&(base[3]==test[ 0 ])&&(base[4]==test[ 4 ]))
    {
     orient =  39 ;
     }

    if((base[0]==test[ 3 ])&&(base[1]==test[ 1 ])&&(base[2]==test[ 0 ])&&(base[3]==test[ 4 ])&&(base[4]==test[ 2 ]))
    {
     orient =  40 ;
     }

    if((base[0]==test[ 3 ])&&(base[1]==test[ 1 ])&&(base[2]==test[ 0 ])&&(base[3]==test[ 2 ])&&(base[4]==test[ 4 ]))
    {
     orient =  41 ;
     }

    if((base[0]==test[ 3 ])&&(base[1]==test[ 0 ])&&(base[2]==test[ 4 ])&&(base[3]==test[ 2 ])&&(base[4]==test[ 1 ]))
    {
     orient =  42 ;
     }

    if((base[0]==test[ 3 ])&&(base[1]==test[ 0 ])&&(base[2]==test[ 4 ])&&(base[3]==test[ 1 ])&&(base[4]==test[ 2 ]))
    {
     orient =  43 ;
     }

    if((base[0]==test[ 3 ])&&(base[1]==test[ 0 ])&&(base[2]==test[ 2 ])&&(base[3]==test[ 4 ])&&(base[4]==test[ 1 ]))
    {
     orient =  44 ;
     }

    if((base[0]==test[ 3 ])&&(base[1]==test[ 0 ])&&(base[2]==test[ 2 ])&&(base[3]==test[ 1 ])&&(base[4]==test[ 4 ]))
    {
     orient =  45 ;
     }

    if((base[0]==test[ 3 ])&&(base[1]==test[ 0 ])&&(base[2]==test[ 1 ])&&(base[3]==test[ 4 ])&&(base[4]==test[ 2 ]))
    {
     orient =  46 ;
     }

    if((base[0]==test[ 3 ])&&(base[1]==test[ 0 ])&&(base[2]==test[ 1 ])&&(base[3]==test[ 2 ])&&(base[4]==test[ 4 ]))
    {
     orient =  47 ;
     }

    if((base[0]==test[ 2 ])&&(base[1]==test[ 4 ])&&(base[2]==test[ 3 ])&&(base[3]==test[ 1 ])&&(base[4]==test[ 0 ]))
    {
     orient =  48 ;
     }

    if((base[0]==test[ 2 ])&&(base[1]==test[ 4 ])&&(base[2]==test[ 3 ])&&(base[3]==test[ 0 ])&&(base[4]==test[ 1 ]))
    {
     orient =  49 ;
     }

    if((base[0]==test[ 2 ])&&(base[1]==test[ 4 ])&&(base[2]==test[ 1 ])&&(base[3]==test[ 3 ])&&(base[4]==test[ 0 ]))
    {
     orient =  50 ;
     }

    if((base[0]==test[ 2 ])&&(base[1]==test[ 4 ])&&(base[2]==test[ 1 ])&&(base[3]==test[ 0 ])&&(base[4]==test[ 3 ]))
    {
     orient =  51 ;
     }

    if((base[0]==test[ 2 ])&&(base[1]==test[ 4 ])&&(base[2]==test[ 0 ])&&(base[3]==test[ 3 ])&&(base[4]==test[ 1 ]))
    {
     orient =  52 ;
     }

    if((base[0]==test[ 2 ])&&(base[1]==test[ 4 ])&&(base[2]==test[ 0 ])&&(base[3]==test[ 1 ])&&(base[4]==test[ 3 ]))
    {
     orient =  53 ;
     }

    if((base[0]==test[ 2 ])&&(base[1]==test[ 3 ])&&(base[2]==test[ 4 ])&&(base[3]==test[ 1 ])&&(base[4]==test[ 0 ]))
    {
     orient =  54 ;
     }

    if((base[0]==test[ 2 ])&&(base[1]==test[ 3 ])&&(base[2]==test[ 4 ])&&(base[3]==test[ 0 ])&&(base[4]==test[ 1 ]))
    {
     orient =  55 ;
     }

    if((base[0]==test[ 2 ])&&(base[1]==test[ 3 ])&&(base[2]==test[ 1 ])&&(base[3]==test[ 4 ])&&(base[4]==test[ 0 ]))
    {
     orient =  56 ;
     }

    if((base[0]==test[ 2 ])&&(base[1]==test[ 3 ])&&(base[2]==test[ 1 ])&&(base[3]==test[ 0 ])&&(base[4]==test[ 4 ]))
    {
     orient =  57 ;
     }

    if((base[0]==test[ 2 ])&&(base[1]==test[ 3 ])&&(base[2]==test[ 0 ])&&(base[3]==test[ 4 ])&&(base[4]==test[ 1 ]))
    {
     orient =  58 ;
     }

    if((base[0]==test[ 2 ])&&(base[1]==test[ 3 ])&&(base[2]==test[ 0 ])&&(base[3]==test[ 1 ])&&(base[4]==test[ 4 ]))
    {
     orient =  59 ;
     }

    if((base[0]==test[ 2 ])&&(base[1]==test[ 1 ])&&(base[2]==test[ 4 ])&&(base[3]==test[ 3 ])&&(base[4]==test[ 0 ]))
    {
     orient =  60 ;
     }

    if((base[0]==test[ 2 ])&&(base[1]==test[ 1 ])&&(base[2]==test[ 4 ])&&(base[3]==test[ 0 ])&&(base[4]==test[ 3 ]))
    {
     orient =  61 ;
     }

    if((base[0]==test[ 2 ])&&(base[1]==test[ 1 ])&&(base[2]==test[ 3 ])&&(base[3]==test[ 4 ])&&(base[4]==test[ 0 ]))
    {
     orient =  62 ;
     }

    if((base[0]==test[ 2 ])&&(base[1]==test[ 1 ])&&(base[2]==test[ 3 ])&&(base[3]==test[ 0 ])&&(base[4]==test[ 4 ]))
    {
     orient =  63 ;
     }

    if((base[0]==test[ 2 ])&&(base[1]==test[ 1 ])&&(base[2]==test[ 0 ])&&(base[3]==test[ 4 ])&&(base[4]==test[ 3 ]))
    {
     orient =  64 ;
     }

    if((base[0]==test[ 2 ])&&(base[1]==test[ 1 ])&&(base[2]==test[ 0 ])&&(base[3]==test[ 3 ])&&(base[4]==test[ 4 ]))
    {
     orient =  65 ;
     }

    if((base[0]==test[ 2 ])&&(base[1]==test[ 0 ])&&(base[2]==test[ 4 ])&&(base[3]==test[ 3 ])&&(base[4]==test[ 1 ]))
    {
     orient =  66 ;
     }

    if((base[0]==test[ 2 ])&&(base[1]==test[ 0 ])&&(base[2]==test[ 4 ])&&(base[3]==test[ 1 ])&&(base[4]==test[ 3 ]))
    {
     orient =  67 ;
     }

    if((base[0]==test[ 2 ])&&(base[1]==test[ 0 ])&&(base[2]==test[ 3 ])&&(base[3]==test[ 4 ])&&(base[4]==test[ 1 ]))
    {
     orient =  68 ;
     }

    if((base[0]==test[ 2 ])&&(base[1]==test[ 0 ])&&(base[2]==test[ 3 ])&&(base[3]==test[ 1 ])&&(base[4]==test[ 4 ]))
    {
     orient =  69 ;
     }

    if((base[0]==test[ 2 ])&&(base[1]==test[ 0 ])&&(base[2]==test[ 1 ])&&(base[3]==test[ 4 ])&&(base[4]==test[ 3 ]))
    {
     orient =  70 ;
     }

    if((base[0]==test[ 2 ])&&(base[1]==test[ 0 ])&&(base[2]==test[ 1 ])&&(base[3]==test[ 3 ])&&(base[4]==test[ 4 ]))
    {
     orient =  71 ;
     }

    if((base[0]==test[ 1 ])&&(base[1]==test[ 4 ])&&(base[2]==test[ 3 ])&&(base[3]==test[ 2 ])&&(base[4]==test[ 0 ]))
    {
     orient =  72 ;
     }

    if((base[0]==test[ 1 ])&&(base[1]==test[ 4 ])&&(base[2]==test[ 3 ])&&(base[3]==test[ 0 ])&&(base[4]==test[ 2 ]))
    {
     orient =  73 ;
     }

    if((base[0]==test[ 1 ])&&(base[1]==test[ 4 ])&&(base[2]==test[ 2 ])&&(base[3]==test[ 3 ])&&(base[4]==test[ 0 ]))
    {
     orient =  74 ;
     }

    if((base[0]==test[ 1 ])&&(base[1]==test[ 4 ])&&(base[2]==test[ 2 ])&&(base[3]==test[ 0 ])&&(base[4]==test[ 3 ]))
    {
     orient =  75 ;
     }

    if((base[0]==test[ 1 ])&&(base[1]==test[ 4 ])&&(base[2]==test[ 0 ])&&(base[3]==test[ 3 ])&&(base[4]==test[ 2 ]))
    {
     orient =  76 ;
     }

    if((base[0]==test[ 1 ])&&(base[1]==test[ 4 ])&&(base[2]==test[ 0 ])&&(base[3]==test[ 2 ])&&(base[4]==test[ 3 ]))
    {
     orient =  77 ;
     }

    if((base[0]==test[ 1 ])&&(base[1]==test[ 3 ])&&(base[2]==test[ 4 ])&&(base[3]==test[ 2 ])&&(base[4]==test[ 0 ]))
    {
     orient =  78 ;
     }

    if((base[0]==test[ 1 ])&&(base[1]==test[ 3 ])&&(base[2]==test[ 4 ])&&(base[3]==test[ 0 ])&&(base[4]==test[ 2 ]))
    {
     orient =  79 ;
     }

    if((base[0]==test[ 1 ])&&(base[1]==test[ 3 ])&&(base[2]==test[ 2 ])&&(base[3]==test[ 4 ])&&(base[4]==test[ 0 ]))
    {
     orient =  80 ;
     }

    if((base[0]==test[ 1 ])&&(base[1]==test[ 3 ])&&(base[2]==test[ 2 ])&&(base[3]==test[ 0 ])&&(base[4]==test[ 4 ]))
    {
     orient =  81 ;
     }

    if((base[0]==test[ 1 ])&&(base[1]==test[ 3 ])&&(base[2]==test[ 0 ])&&(base[3]==test[ 4 ])&&(base[4]==test[ 2 ]))
    {
     orient =  82 ;
     }

    if((base[0]==test[ 1 ])&&(base[1]==test[ 3 ])&&(base[2]==test[ 0 ])&&(base[3]==test[ 2 ])&&(base[4]==test[ 4 ]))
    {
     orient =  83 ;
     }

    if((base[0]==test[ 1 ])&&(base[1]==test[ 2 ])&&(base[2]==test[ 4 ])&&(base[3]==test[ 3 ])&&(base[4]==test[ 0 ]))
    {
     orient =  84 ;
     }

    if((base[0]==test[ 1 ])&&(base[1]==test[ 2 ])&&(base[2]==test[ 4 ])&&(base[3]==test[ 0 ])&&(base[4]==test[ 3 ]))
    {
     orient =  85 ;
     }

    if((base[0]==test[ 1 ])&&(base[1]==test[ 2 ])&&(base[2]==test[ 3 ])&&(base[3]==test[ 4 ])&&(base[4]==test[ 0 ]))
    {
     orient =  86 ;
     }

    if((base[0]==test[ 1 ])&&(base[1]==test[ 2 ])&&(base[2]==test[ 3 ])&&(base[3]==test[ 0 ])&&(base[4]==test[ 4 ]))
    {
     orient =  87 ;
     }

    if((base[0]==test[ 1 ])&&(base[1]==test[ 2 ])&&(base[2]==test[ 0 ])&&(base[3]==test[ 4 ])&&(base[4]==test[ 3 ]))
    {
     orient =  88 ;
     }

    if((base[0]==test[ 1 ])&&(base[1]==test[ 2 ])&&(base[2]==test[ 0 ])&&(base[3]==test[ 3 ])&&(base[4]==test[ 4 ]))
    {
     orient =  89 ;
     }

    if((base[0]==test[ 1 ])&&(base[1]==test[ 0 ])&&(base[2]==test[ 4 ])&&(base[3]==test[ 3 ])&&(base[4]==test[ 2 ]))
    {
     orient =  90 ;
     }

    if((base[0]==test[ 1 ])&&(base[1]==test[ 0 ])&&(base[2]==test[ 4 ])&&(base[3]==test[ 2 ])&&(base[4]==test[ 3 ]))
    {
     orient =  91 ;
     }

    if((base[0]==test[ 1 ])&&(base[1]==test[ 0 ])&&(base[2]==test[ 3 ])&&(base[3]==test[ 4 ])&&(base[4]==test[ 2 ]))
    {
     orient =  92 ;
     }

    if((base[0]==test[ 1 ])&&(base[1]==test[ 0 ])&&(base[2]==test[ 3 ])&&(base[3]==test[ 2 ])&&(base[4]==test[ 4 ]))
    {
     orient =  93 ;
     }

    if((base[0]==test[ 1 ])&&(base[1]==test[ 0 ])&&(base[2]==test[ 2 ])&&(base[3]==test[ 4 ])&&(base[4]==test[ 3 ]))
    {
     orient =  94 ;
     }

    if((base[0]==test[ 1 ])&&(base[1]==test[ 0 ])&&(base[2]==test[ 2 ])&&(base[3]==test[ 3 ])&&(base[4]==test[ 4 ]))
    {
     orient =  95 ;
     }

    if((base[0]==test[ 0 ])&&(base[1]==test[ 4 ])&&(base[2]==test[ 3 ])&&(base[3]==test[ 2 ])&&(base[4]==test[ 1 ]))
    {
     orient =  96 ;
     }

    if((base[0]==test[ 0 ])&&(base[1]==test[ 4 ])&&(base[2]==test[ 3 ])&&(base[3]==test[ 1 ])&&(base[4]==test[ 2 ]))
    {
     orient =  97 ;
     }

    if((base[0]==test[ 0 ])&&(base[1]==test[ 4 ])&&(base[2]==test[ 2 ])&&(base[3]==test[ 3 ])&&(base[4]==test[ 1 ]))
    {
     orient =  98 ;
     }

    if((base[0]==test[ 0 ])&&(base[1]==test[ 4 ])&&(base[2]==test[ 2 ])&&(base[3]==test[ 1 ])&&(base[4]==test[ 3 ]))
    {
     orient =  99 ;
     }

    if((base[0]==test[ 0 ])&&(base[1]==test[ 4 ])&&(base[2]==test[ 1 ])&&(base[3]==test[ 3 ])&&(base[4]==test[ 2 ]))
    {
     orient =  100 ;
     }

    if((base[0]==test[ 0 ])&&(base[1]==test[ 4 ])&&(base[2]==test[ 1 ])&&(base[3]==test[ 2 ])&&(base[4]==test[ 3 ]))
    {
     orient =  101 ;
     }

    if((base[0]==test[ 0 ])&&(base[1]==test[ 3 ])&&(base[2]==test[ 4 ])&&(base[3]==test[ 2 ])&&(base[4]==test[ 1 ]))
    {
     orient =  102 ;
     }

    if((base[0]==test[ 0 ])&&(base[1]==test[ 3 ])&&(base[2]==test[ 4 ])&&(base[3]==test[ 1 ])&&(base[4]==test[ 2 ]))
    {
     orient =  103 ;
     }

    if((base[0]==test[ 0 ])&&(base[1]==test[ 3 ])&&(base[2]==test[ 2 ])&&(base[3]==test[ 4 ])&&(base[4]==test[ 1 ]))
    {
     orient =  104 ;
     }

    if((base[0]==test[ 0 ])&&(base[1]==test[ 3 ])&&(base[2]==test[ 2 ])&&(base[3]==test[ 1 ])&&(base[4]==test[ 4 ]))
    {
     orient =  105 ;
     }

    if((base[0]==test[ 0 ])&&(base[1]==test[ 3 ])&&(base[2]==test[ 1 ])&&(base[3]==test[ 4 ])&&(base[4]==test[ 2 ]))
    {
     orient =  106 ;
     }

    if((base[0]==test[ 0 ])&&(base[1]==test[ 3 ])&&(base[2]==test[ 1 ])&&(base[3]==test[ 2 ])&&(base[4]==test[ 4 ]))
    {
     orient =  107 ;
     }

    if((base[0]==test[ 0 ])&&(base[1]==test[ 2 ])&&(base[2]==test[ 4 ])&&(base[3]==test[ 3 ])&&(base[4]==test[ 1 ]))
    {
     orient =  108 ;
     }

    if((base[0]==test[ 0 ])&&(base[1]==test[ 2 ])&&(base[2]==test[ 4 ])&&(base[3]==test[ 1 ])&&(base[4]==test[ 3 ]))
    {
     orient =  109 ;
     }

    if((base[0]==test[ 0 ])&&(base[1]==test[ 2 ])&&(base[2]==test[ 3 ])&&(base[3]==test[ 4 ])&&(base[4]==test[ 1 ]))
    {
     orient =  110 ;
     }

    if((base[0]==test[ 0 ])&&(base[1]==test[ 2 ])&&(base[2]==test[ 3 ])&&(base[3]==test[ 1 ])&&(base[4]==test[ 4 ]))
    {
     orient =  111 ;
     }

    if((base[0]==test[ 0 ])&&(base[1]==test[ 2 ])&&(base[2]==test[ 1 ])&&(base[3]==test[ 4 ])&&(base[4]==test[ 3 ]))
    {
     orient =  112 ;
     }

    if((base[0]==test[ 0 ])&&(base[1]==test[ 2 ])&&(base[2]==test[ 1 ])&&(base[3]==test[ 3 ])&&(base[4]==test[ 4 ]))
    {
     orient =  113 ;
     }

    if((base[0]==test[ 0 ])&&(base[1]==test[ 1 ])&&(base[2]==test[ 4 ])&&(base[3]==test[ 3 ])&&(base[4]==test[ 2 ]))
    {
     orient =  114 ;
     }

    if((base[0]==test[ 0 ])&&(base[1]==test[ 1 ])&&(base[2]==test[ 4 ])&&(base[3]==test[ 2 ])&&(base[4]==test[ 3 ]))
    {
     orient =  115 ;
     }

    if((base[0]==test[ 0 ])&&(base[1]==test[ 1 ])&&(base[2]==test[ 3 ])&&(base[3]==test[ 4 ])&&(base[4]==test[ 2 ]))
    {
     orient =  116 ;
     }

    if((base[0]==test[ 0 ])&&(base[1]==test[ 1 ])&&(base[2]==test[ 3 ])&&(base[3]==test[ 2 ])&&(base[4]==test[ 4 ]))
    {
     orient =  117 ;
     }

    if((base[0]==test[ 0 ])&&(base[1]==test[ 1 ])&&(base[2]==test[ 2 ])&&(base[3]==test[ 4 ])&&(base[4]==test[ 3 ]))
    {
     orient =  118 ;
     }

    if((base[0]==test[ 0 ])&&(base[1]==test[ 1 ])&&(base[2]==test[ 2 ])&&(base[3]==test[ 3 ])&&(base[4]==test[ 4 ]))
    {
     orient =  119 ;
     }
...
int Mesh::CheckBdrElementOrientation(bool fix_it)
{
   ...
   if (Dim >= 3)
   {
       //std::cout << "Boundary check" << std::endl;
      ...
      for (int i = 0; i < NumOfBdrElements; i++)
      {
         ...
         switch (bdr_type)
         {
            ...
            case Element::TETRAHEDRON:
            {
                ...
                //std::cout << "Boundary Tet" << std::endl;
